...
io.on("connection", (socket) => {
  ...
  socket.on('send-pinch-value', (message) => {
    console.log('Received arm pinch value message from frontend:', message);
    client.publish("pinch", message.toString());
  });

  socket.on('send-motorPower', (message) => {
    console.log('Received motor power message from frontend:', message);
    client.publish("motorPower", message.toString());
  });
